...
const GALLERY_ITEMS = [
  ...
  { src: "/imgs-videos/melhoradas/novas/casa_nova_2.webp", label: "Terceiro banheiro (área externa)" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_3.webp", label: "Fachada com o detalhe do lobo entalhado" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_4.webp", label: "Deck da casa, um ótimo espaço para saborear seu café" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_5.webp", label: "Área externa da casa" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_6.webp", label: "Detalhes da decoração rústica com lustre" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_7.webp", label: "Lustre rústico no ambiente" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_8.webp", label: "Cozinha da casa (itens de café da manhã não inclusos)" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_9.webp", label: "Ambiente com lareira" },
  { src: "/imgs-videos/melhoradas/novas/casa_nova_10.webp", label: "Quarto com cama de casal" },
